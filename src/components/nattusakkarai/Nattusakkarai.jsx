...
import Nattusakkarai from '../Assets/img/nattu-sakkarai.jpg';
        ...
        <div className="row g-4 align-items-center">
          <div className="col-lg-6">
            <div className="py-4">
              ...
              <a href="https://api.whatsapp.com/send?phone=919363620057&text=For%20Orders" className="banner-btn">BUY NOW</a>
            </div>
          </div>
            <div className="col-lg-6">
